  ...
  return (
    <nav className='text-primary xl:hidden'>
      ...
      <motion.div
        ...
        initial='hidden'
        animate={openMenu ? 'show' : 'hidden'} // Use 'hidden' state when not open
        ...
        <ul className='h-full flex flex-col justify-center items-center gap-y-8 text-primary font-primary  font-extrabold text-3xl'>
          <li>
